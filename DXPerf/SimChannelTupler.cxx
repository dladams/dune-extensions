...
: m_geohelp(geohelp), m_nscMax(nscMax) {
  ...
  // Sim channel tree.
  m_ptree = tfs.make<TTree>("simchan", "simchan");
...
void SimChannelTupler::fill(const art::EventID& evid, const SimChannelVector& scs) {
...
TTree* SimChannelTupler::tree() const {
  return m_ptree;
}
